...
@onready var mainUI_credit_roller_node = get_parent().get_node("MainUI")
...
func start_transition():
	...
	get_tree().change_scene_to_file("res://scenes/opening_logo_scene.tscn")

func start_transition_creditroll():
	var creditroll_node = mainUI_credit_roller_node.get_node("EndCredits")
	creditroll_node.start_creditroll()
