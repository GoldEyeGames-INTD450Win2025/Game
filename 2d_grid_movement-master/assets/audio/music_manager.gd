...
func _ready():
	...
	# signals for area activators, for dynamic music triggers
	var zone_Activator1_Area2D = get_node("../../Activator1_Area2D")
	...
	var zone_Activator3_Area2D = get_node("../../Activator3_Area2D") 
	...
	var sigd_demoDone = get_node("/root/Map_Danic/Activator3_Area2D/ColorRect2")
	if sigd_demoDone:
